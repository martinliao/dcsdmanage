...
<html>
  <head>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>resource/adminlte/plugins/ckeditor2/ckeditor.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>resource/adminlte/plugins/ckfinder/ckfinder.js"></script>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <?php 
            if($mode == '2'){
                echo '<li style="background-color:purple">
                  <a href="'.base_url("Instant_message/send").'">
                    <i class="fa fa-dashboard"></i> <span>寄件匣</span>
                  </a>
                </li>';
                
                echo '<li>
                  <a href="'.base_url("Instant_message").'">
                    <i class="fa fa-pagelines"></i> <span>歷史匣</span>
                  </a>
                </li>';
            } elseif($mode == '1'){
                echo '<li>
