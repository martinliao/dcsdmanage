<script type="text/javascript">
  ...
  function backFun(){
    location.href="http://192.168.50.29/eda/manage/Instant_message_receive/history";
  }
</script>
    ...
    <div class="dataTables_paginate paging_simple_numbers">
      <ul class="pagination">
        <?php
          if($first == $message[0]->id){
            ...
            echo '<li class="paginate_button">
                <a href="../history_view/'.$first.'">第一封</a>
              </li>';
          }
        ?>
        <?php
          if($prev > 0){
            echo '<li class="paginate_button">
                    <a href="../history_view/'.$prev.'">上一封</a>
                  </li>';
          } else {
            echo '<li class="paginate_button disabled">
                    <a href="#">上一封</a>
        ...
        <?php
          if($next > 0){
              echo '<li class="paginate_button">
                    <a href="../history_view/'.$next.'">下一封</a>
                  </li>';
          } else {
            echo '<li class="paginate_button disabled">
                    <a href="#">下一封</a>
        ...
        <?php
          if($final == $message[0]->id){
            ...
            echo '<li class="paginate_button">
                <a href="../history_view/'.$final.'">最末封</a>
              </li>';
          }
        ?>
      </ul>
