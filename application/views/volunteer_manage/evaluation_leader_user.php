...
<div class="col-xs-12">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title">M.績效考核組長設定</h3>
    </div><!-- /.box-header -->
    <form method="POST" action="<?php echo base_url('volunteer_manage/evaluation_leader_user_add') ?>">
    <div class="box-body">
        <div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-dataset">
                      <a href="#" onclick="remove_data(\''.base_url().'volunteer_manage/evaluation_leader_user_remove/\',{\'userID\':\''.$each->id.'\'})" title="edit" class="btn btn-default btn-xs"><i class="fa fa-trash fa-trash"></i>&nbsp;&nbsp;刪除</a>
                    </div>
                  </td>
                 </tr> 
              ';
