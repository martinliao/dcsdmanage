                ...
                <table id="example2" class="table table-bordered table-hover" style="text-align:center;vertical-align:middle;font-size:20px">
                    ...
                    <?php
                        for($i=0;$i<count($info);$i++){
                            ...
                            if(in_array($info[$i]['category_id'], $leader) && $info[$i]['undertaker_status']=='1'){
                                $show_leader_top_grade = !empty($info[$i]['leader_top_grade'])?htmlspecialchars($info[$i]['leader_top_grade'],ENT_HTML5|ENT_QUOTES):htmlspecialchars($info[$i]['undertaker_top_grade'],ENT_HTML5|ENT_QUOTES);
